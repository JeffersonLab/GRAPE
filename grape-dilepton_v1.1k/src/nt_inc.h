...
C        parameter (cnextn ='6')   !!!
      double precision  vec_px, vec_py, vec_pz, vec_e, vec_m
       common /NT_VEC1/  vec_px, vec_py, vec_pz, vec_e, vec_m
      character*(*) NT_VEC
     ...
     &                        ,pm(N_max)
       common /NT_PYTHIA1/ Npy, px, py, pz, pe, pm, kf, sta, mot
      character*(*) PYTHIA
      parameter (   PYTHIA =
     &                       'npy[0,'//cN_max//']:i'
     &                    //',px(npy):r*4'
     ...
     &          )
      ...
      character*(*)   NT_NAME, NT_TITLE
       parameter(NTID=1, NT_NAME='grp.hbook', NT_TITLE = 'GRAPE Ntuple'
